...
${execution.getProcessEngineServices().getRuntimeService().createMessageCorrelation("cancelOrderMessage").setVariables(execution.getVariables()).correlateWithResult()}
...
https://cloud.spring.io/spring-cloud-contract/spring-cloud-contract-maven-plugin/generateTests-mojo.html
